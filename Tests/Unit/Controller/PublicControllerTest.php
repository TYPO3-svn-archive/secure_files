...
/**
 * Test case for class Tx_Secure_files_Controller_PublicController.
 *
 * @version $Id$
 ...
 */
class Tx_Secure_files_Controller_PublicControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
